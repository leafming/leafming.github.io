...
> 本文所用flink版本为V1.7-SNAPSHOT，官网翻译转载，转载地址：[配置-https://flink.lantingmeeting.com/ops/config.html#legacy](https://flink.lantingmeeting.com/ops/config.html#legacy)，官方文档原文[Configuration](https://ci.apache.org/projects/flink/flink-docs-master/ops/config.html#configuration)。  
